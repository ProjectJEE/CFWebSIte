		...
		$(document).ready(
				function() {
					$('#colour-variations ul').styleSwitcher({
						// the document id of the default theme CSS file, will be replaced with the user selection
						defaultThemeId : 'theme-switch',
						// when set to true, hover events on the theme lists will trigger a style change
						hasPreview : false,
